...
pub mod pallet {
    ...
    use helpers::numbers::{FixedPointMath, UnsignedMath};
    ...
    use sp_std::ops::Add;
    use traits::vamm::{AssetType, Direction, SwapConfig, SwapOutput, Vamm};
    ...
    impl<T: Config> Default for GenesisConfig<T> {
        fn default() -> Self {
            Self {
                vamm_id: None,
                price: Some(T::Decimal::one()),
                twap: Some(T::Decimal::one()),
            }
        }
    }
    ...
    impl<T: Config> Vamm for Pallet<T> {
        ...
        fn swap(config: &Self::SwapConfig) -> Result<SwapOutputOf<T>, DispatchError> {
            ...
            if let Some(ref slippage) = Self::_slippage() {
                ...
                output
                    .output
                    .try_sub_mut(&slippage.saturating_mul_int(output.output))?;
            }
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn get_value(
            ...
            Ok(match asset_type {
                ...
                AssetType::Quote => amount_decimal
                    .checked_div(&price)
