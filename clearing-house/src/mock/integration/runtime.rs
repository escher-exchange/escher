...
use frame_support::{
    ...
    traits::{ConstU16, ConstU32, ConstU64, EitherOfDiverse, Everything, GenesisBuild},
    PalletId,
};
...
// -------------------------------------------------------------------------------------------------
//                                             Oracle
//                               This section is mostly copied from
//            https://github.com/ComposableFi/composable/blob/main/frame/oracle/src/mock.rs
// -------------------------------------------------------------------------------------------------
...
impl pallet_oracle::Config for Runtime {
    ...
    type AddOracle = EitherOfDiverse<EnsureSignedBy<RootAccount, AccountId>, EnsureRoot<AccountId>>;
...
impl clearing_house::Config for Runtime {
    ...
    type Vamm = Vamm;
    type VammConfig = traits::vamm::VammConfig<Balance, Moment>;
    type VammId = VammId;
    type WeightInfo = ();
}
